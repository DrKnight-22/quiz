...
const StudentScores = () => {
  ...
  useEffect(() => {
    const fetchScores = async () => {
      try {
        ...
        // Get scores for these quizzes with related data
        const scoresData = db.get('quiz_results')
          .filter(r => quizzes.includes(r.quiz_id))
          .map(score => ({
            ...score,
  ...
  if (loading) {
    return (
      <Layout title="Student Scores" role="teacher">
