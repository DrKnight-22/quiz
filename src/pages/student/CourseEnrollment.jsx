...
import { collection, query, where, addDoc, doc, getDoc, deleteDoc, onSnapshot, getDocs } from "firebase/firestore"
...
const CourseEnrollment = () => {
  ...
  const fetchCourseMaterials = async (courseId) => {
    ...
    try {
      ...
      const materialsQuery = query(collection(db, "courseMaterials"), where("courseId", "==", courseId))
      ...
      <div className="animate-fade-in">
        ...
        {userRole === "teacher" ? (
          activeTab === "my-courses" ? (
            ...
            <>
              <h2 className="text-xl font-semibold text-gray-700 mb-6">All Courses</h2>
